...
parser.add_argument('--model_path', default='pointconv_scannet_2019_11_03_04_05_20_combined_591/best_model_epoch_416.ckpt', help='model checkpoint file path [default: log/model.ckpt]')
